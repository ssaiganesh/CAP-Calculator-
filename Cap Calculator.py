...
##This can be changed to dictionary. 
...
def freshie():
    ...
    if freshie_check == "N":
        ...
        completed_mc = int(input("How many Modular Credits have been completed? "))
    else:
        current_cap = 0
        completed_mc = 0
...
def main():
    updated_cap = (current_cap*completed_mc + sap)/(completed_mc + new_mc)
    print(updated_cap)
